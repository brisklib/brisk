...
constexpr inline Argument<Tag::PropArg<decltype(Widget::absolutePosition)>> absolutePosition{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::alignContent)>> alignContent{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::alignItems)>> alignItems{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::alignSelf)>> alignSelf{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::anchor)>> anchor{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::aspect)>> aspect{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::backgroundColorEasing)>> backgroundColorEasing{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::backgroundColorTransition)>> backgroundColorTransition{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::backgroundColor)>> backgroundColor{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderColorEasing)>> borderColorEasing{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderColorTransition)>> borderColorTransition{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderColor)>> borderColor{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderRadius)>> borderRadius{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderWidth)>> borderWidth{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::clip)>> clip{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::colorEasing)>> colorEasing{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::colorTransition)>> colorTransition{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::color)>> color{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::corners)>> corners{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::cursor)>> cursor{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::dimensions)>> dimensions{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::flexBasis)>> flexBasis{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::flexGrow)>> flexGrow{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::flexShrink)>> flexShrink{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::flexWrap)>> flexWrap{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::fontFamily)>> fontFamily{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::fontSize)>> fontSize{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::fontStyle)>> fontStyle{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::fontWeight)>> fontWeight{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::gap)>> gap{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::hidden)>> hidden{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::justifyContent)>> justifyContent{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::layoutOrder)>> layoutOrder{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::layout)>> layout{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::letterSpacing)>> letterSpacing{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::margin)>> margin{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::maxDimensions)>> maxDimensions{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::minDimensions)>> minDimensions{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::opacity)>> opacity{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::overflow)>> overflow{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::padding)>> padding{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::placement)>> placement{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::shadowSize)>> shadowSize{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::shadowColor)>> shadowColor{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::shadowColorTransition)>> shadowColorTransition{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::shadowColorEasing)>> shadowColorEasing{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::tabSize)>> tabSize{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::textAlign)>> textAlign{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::textVerticalAlign)>> textVerticalAlign{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::textDecoration)>> textDecoration{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::translate)>> translate{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::visible)>> visible{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::wordSpacing)>> wordSpacing{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::alignToViewport)>> alignToViewport{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::stateTriggersRestyle)>> stateTriggersRestyle{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::id)>> id{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::role)>> role{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::classes)>> classes{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::mouseInteraction)>> mouseInteraction{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::mousePassThrough)>> mousePassThrough{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::autoMouseCapture)>> autoMouseCapture{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::mouseAnywhere)>> mouseAnywhere{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::focusCapture)>> focusCapture{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::description)>> description{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::tabStop)>> tabStop{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::tabGroup)>> tabGroup{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::autofocus)>> autofocus{};
...
constexpr inline Argument<Tag::PropArg<decltype(Widget::delegate)>> delegate{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::hint)>> hint{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::zorder)>> zorder{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::stylesheet)>> stylesheet{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::painter)>> painter{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::isHintExclusive)>> isHintExclusive{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::borderRadiusTopLeft)>> borderRadiusTopLeft{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderRadiusTopRight)>> borderRadiusTopRight{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderRadiusBottomLeft)>> borderRadiusBottomLeft{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderRadiusBottomRight)>> borderRadiusBottomRight{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::borderWidthLeft)>> borderWidthLeft{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderWidthTop)>> borderWidthTop{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderWidthRight)>> borderWidthRight{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::borderWidthBottom)>> borderWidthBottom{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::marginLeft)>> marginLeft{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::marginTop)>> marginTop{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::marginRight)>> marginRight{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::marginBottom)>> marginBottom{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::paddingLeft)>> paddingLeft{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::paddingTop)>> paddingTop{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::paddingRight)>> paddingRight{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::paddingBottom)>> paddingBottom{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::width)>> width{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::height)>> height{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::maxWidth)>> maxWidth{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::maxHeight)>> maxHeight{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::minWidth)>> minWidth{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::minHeight)>> minHeight{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::gapColumn)>> gapColumn{};
constexpr inline Argument<Tag::PropArg<decltype(Widget::gapRow)>> gapRow{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::disabled)>> disabled{};

constexpr inline Argument<Tag::PropArg<decltype(Widget::fontFeatures)>> fontFeatures{};
