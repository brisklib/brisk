...
Widget::properties() noexcept {
    static constexpr tuplet::tuple props{
        ...
        /* 15 */
        Internal::PropGui{ &Widget::m_borderColor, &Widget::m_borderColorTransition, Transition | AffectPaint,
                           "borderColor" },
        ...
        /* 38 */
        Internal::PropGui{ &Widget::m_shadowColor, &Widget::m_shadowColorTransition, Transition | AffectPaint,
                           "shadowColor" },
        ...
        /* 73 */
        Internal::PropGui{ &Widget::m_scrollBarThickness, Resolvable | AffectPaint, "scrollBarThickness" },
        /* 74 */
        ...
        /* 83 */
        Internal::PropGui{ &Widget::m_borderWidthBottom, AffectLayout | AffectPaint, "borderWidthBottom" },
