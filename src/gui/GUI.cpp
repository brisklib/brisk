...
template <size_t index_, typename T, PropFlags flags_, PropFieldStorageType<T, flags_> Widget::* field,
          int subfield>
inline auto GUIProperty<index_, T, flags_, field, subfield>::resolved() const noexcept
...
template <size_t index_, typename T, PropFlags flags_, PropFieldStorageType<T, flags_> Widget::* field,
          int subfield>
inline auto GUIProperty<index_, T, flags_, field, subfield>::current() const noexcept
    -> OptConstRef<ValueType>
...
template <size_t index_, typename T, PropFlags flags_, PropFieldStorageType<T, flags_> Widget::* field,
          int subfield>
inline void GUIProperty<index_, T, flags_, field, subfield>::set(ValueType value) {
    this_pointer->setter<T, index, flags_, field, subfield>(std::move(value));
}

template <size_t index_, typename T, PropFlags flags_, PropFieldStorageType<T, flags_> Widget::* field,
          int subfield>
inline void GUIProperty<index_, T, flags_, field, subfield>::set(Inherit inherit)
...
inline OptConstRef<Type_> GUIPropertyCompound<index_, Type_, flags_, field, Properties...>::get()
    const noexcept {
...
template <size_t index_, typename Type_, PropFlags flags_,
          PropFieldStorageType<Type_, flags_> Widget::* field, typename... Properties>
inline OptConstRef<ResolvedType<Type_>> GUIPropertyCompound<index_, Type_, flags_, field,
                                                            Properties...>::resolved() const noexcept
...
template <size_t index_, typename Type_, PropFlags flags_,
          PropFieldStorageType<Type_, flags_> Widget::* field, typename... Properties>
inline void GUIPropertyCompound<index_, Type_, flags_, field, Properties...>::set(Type value) {
    (Properties{ this_pointer }.set(Properties::sub(value)), ...);
}

template <size_t index_, typename Type_, PropFlags flags_,
          PropFieldStorageType<Type_, flags_> Widget::* field, typename... Properties>
inline void GUIPropertyCompound<index_, Type_, flags_, field, Properties...>::set(Inherit value)
