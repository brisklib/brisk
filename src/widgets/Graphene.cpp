    ...
    return rcnew Stylesheet{
        ...
        Style{
            Type{ Knob::widgetType },
            {
                ...
                transitionDuration(borderColor)           = 250ms,
                transitionDuration(borderColor) | Hover   = 150ms,
                transitionDuration(borderColor) | Pressed = 20ms,
            },
        },
        Style{
        ...
        Style{
            Type{ TextEditor::widgetType },
            {
                ...
                transitionDuration(backgroundColor)           = 250ms,
                transitionDuration(backgroundColor) | Focused = 50ms,
                transitionDuration(backgroundColor) | Hover   = 150ms,
        ...
        Style{
            ...
            {
                backgroundColor                     = Palette::transparent,
                transitionDuration(backgroundColor) = 100ms,
                borderColor                         = styleVar<selectedColor>,
                borderRadius                        = 0.f, //
                borderWidth                         = 0,
        ...
        Style{
            Type{ Button::widgetType } || Type{ ComboBox::widgetType },
            {
                transitionDuration(backgroundColor)           = 250ms,
                transitionDuration(backgroundColor) | Hover   = 150ms,
                transitionDuration(backgroundColor) | Pressed = 20ms,
                borderColor                                   = styleVar<boxBorderColor>,
                borderRadius                                  = styleVar<boxRadius>, //
                borderWidth                                   = 1.f,
                transitionDuration(color)                     = 250ms,
                transitionDuration(color) | Hover             = 150ms,
                transitionDuration(color) | Pressed           = 20ms,
                padding                                       = { 16_apx, 5_apx },
